 ...
 * @date   5 apr 2019
 * @brief  Implementation of pea12_zybo class
 ******************************************************************************/
...
void PEA12_zybo::dct(const cv::Mat& input, cv::Mat& output){
#ifdef __DEBUG__
    std::cout<<"\nCalling PEA12 Zybo Linux driver...";
#endif

	int fd;
	unsigned pea12_base_addr = 0x43C00000; //BE SURE THAT THIS IS THE BASE ADDRESS OF THE AXI PERIPHERAL IN THE HW DESIGN
	...
	page_addr = (pea12_base_addr & (~(page_size-1)));
	page_offset = pea12_base_addr - page_addr;
