 ...
 * @date   5 apr 2019
 * @brief  Implementation of cb11_zybo class
 ******************************************************************************/
...
void CB11_zybo::dct(const cv::Mat& input, cv::Mat& output){
#ifdef __DEBUG__
    std::cout<<"\nCalling CB11 Zybo Linux driver...";
#endif

	int fd;
	unsigned cb11_base_addr = 0x43C00000; //BE SURE THAT THIS IS THE BASE ADDRESS OF THE AXI PERIPHERAL IN THE HW DESIGN
	...
	page_addr = (cb11_base_addr & (~(page_size-1)));
	page_offset = cb11_base_addr - page_addr;
