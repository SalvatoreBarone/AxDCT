 ...
 * @date   10 apr 2019
 * @brief  Implementation of bas08_zybo class
 ******************************************************************************/
...
void BAS08_zybo::dct(const cv::Mat& input, cv::Mat& output){
#ifdef __DEBUG__
    std::cout<<"\nCalling BAS08 Zybo Linux driver...";
#endif

	int fd;
	unsigned bas08_base_addr = 0x43C00000; //BE SURE THAT THIS IS THE BASE ADDRESS OF THE AXI PERIPHERAL IN THE HW DESIGN
	...
	page_addr = (bas08_base_addr & (~(page_size-1)));
	page_offset = bas08_base_addr - page_addr;
