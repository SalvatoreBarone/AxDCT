...
void BAS08::y_dequantizate(const cv::Mat& tile, cv::Mat& output) {
    dequantizate(tile, this->getQ(), output);
}

void BAS08::cr_dequantizate(const cv::Mat& tile, cv::Mat& output){
    dequantizate(tile, this->getCQ(), output);
}

void BAS08::cb_dequantizate(const cv::Mat& tile, cv::Mat& output){
    dequantizate(tile, this->getCQ(), output);
}
